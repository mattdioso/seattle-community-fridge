    ...
    return (
        <section className="text-center">
            ...
            <p className="text-black text-xl w-2/3 mx-auto my-8">
                ...
                by providing fridges and fresh food directly to communities. Seattle Community Fridge believes that food scarcity is 
                ...
                non-hierarchically with group consensus for ideas and decision-making.
            </p>
            ...
            <div>
                ...
                <p className="text-black text-xl w-2/3 mx-auto my-8">
                    ...
                    Mutual aid is a <span className="font-bold">community-led solution</span> for meeting those needs and filling the gaps.
                </p>
            </div>
        </section>
    )
